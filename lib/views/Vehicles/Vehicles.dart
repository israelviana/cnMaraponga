...
import 'package:app_transito/views/Vehicles/Widgets/VeiculosList.dart';
...
class _VehiclesState extends State<Vehicles> {
  ...
  _buscarPlaca(String placa) async {
    ...
    List<Map<String, dynamic>> veiculos = await database
        .query('veiculos', where: '"placa" = ?', whereArgs: ['$placa']);
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: RefreshIndicator(
            onRefresh: () =>
                Future.delayed(Duration(milliseconds: 500), () => initState()),
                    ...
                    children: [
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: InputForm(
                                    title:
                                        'Digite a PLACA pelo qual deseja buscar',
                                    mask: "PLACA",
                                    type: "TEXT",
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                height: 30,
                                decoration:
                                    BoxDecoration(color: Color(0xFFf0821e)),
                      ...
                      listVeiculo.length == 0
                          ? Padding(
                              ...
                              child: Center(
                                  child: Text("Não possui dados de veiculos!!!",
                                      style: TextStyle(
                                          fontFamily: "OpensSans",
                                          fontSize: 20,
                                          color: Color(0xFFf0821e)))),
                          ...
                          : Padding(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    return VeiculosList(
                                        modelo: listVeiculo[index].modelo,
                                        cor: listVeiculo[index].cor,
                                        placa: listVeiculo[index].placa,
                                        condutor: listVeiculo[index].condutor,
                                        telefone: listVeiculo[index].telefone,
                                        funcao: () => _modal(typeModal.modal,
                                            listVeiculo[index].id.toString()));
                                  }),
                            )
                    ],
                  )
                          ...
                          child: Column(
                            children: [
                              ...
                              Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ButtonOptions("Excluir veiculo",
                                      () => _excluirVeiculo(id)),
                                  SizedBox(height: 64),
                                  ButtonOptions(
                                      "Editar veiculo",
                                      () => Navigator.popAndPushNamed(
                                          context, editVehiclesRoute,
                                          arguments: id)),
                                ],
                              ),
                            ],
  ...
  _excluirVeiculo(String id) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [Flexible(child: Text("Veiculo excluido com sucesso!!"))],
        ),
